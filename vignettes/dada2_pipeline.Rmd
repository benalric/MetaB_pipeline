...
foreach(i = runs, .packages = c("data.table","dada2")) %dopar% {
  ...
  dev.off()
  save(errF, file = paste0(path, "/dada2/log/errF_",i,".rda")) # CHANGE ME to where you want learn error models saved
  save(errR, file = paste0(path, "/dada2/log/errR_",i,".rda")) # CHANGE ME to where you want learn error models saved
}
...
foreach(i = runs, .packages = c("data.table","dada2")) %dopar% {
  ...
  saveRDS(mergers, paste0(path, "/dada2/log/mergers_",i,".rds")) # CHANGE ME to where you want merged files saved
}
